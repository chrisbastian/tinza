		...
		<li <?php post_class("home-features-item".$_sub_class);?>>
			...
			<div class="post-info-thumbnail">
				...
				<div class="post-info-meta">
					...
					<?php endif;?>
					<?php if( $archive_page_config['show_views_count'] == 1 ) : ?>	
						<span class="views-count<?php if( $archive_page_config['show_views_count_phone'] != 1 ) echo " hidden-phone";?>">
			...
			<?php if( $archive_page_config['show_read_more'] == 1 ) : ?>
				<a title="Readmore" class="read-more <?php if( $archive_page_config['show_read_more_phone'] != 1 ) echo " hidden-phone";?>" href="<?php the_permalink() ; ?>"><span><span><?php _e('Read more','wpdance'); ?></span></span></a>	
			<?php endif;?>
