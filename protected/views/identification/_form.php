...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'id_use_ground'); ?>
		<?php echo $form->textField($model,'id_use_ground'); ?>
		<?php echo $form->error($model,'id_use_ground'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'soil_date_expedition'); ?>
		<?php echo $form->textField($model,'soil_date_expedition'); ?>
		<?php echo $form->error($model,'soil_date_expedition'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'soil_date_expiration'); ?>
		<?php echo $form->textField($model,'soil_date_expiration'); ?>
		<?php echo $form->error($model,'soil_date_expiration'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'document_identification'); ?>
		<?php echo $form->textField($model,'document_identification',array('size'=>60,'maxlength'=>500)); ?>
		<?php echo $form->error($model,'document_identification'); ?>
	</div>
